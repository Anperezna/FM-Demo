...
public class Entrenador extends Persona {
    ...
    protected static boolean seleccionador;


    // Constructor


    public Entrenador(String nom, String cognom, int fecha, int motivacio, double sou_anual, int tornejos_guanyats) {
        super(nom, cognom, fecha, motivacio, sou_anual);
        this.tornejos_guanyats = tornejos_guanyats;
    }

    public Entrenador(String nom, String cognom, int fecha, int motivacio, double sou_anual, int tornejos_guanyats, boolean seleccionador) {
        super(nom, cognom, fecha, motivacio, sou_anual);
        this.tornejos_guanyats = tornejos_guanyats;
    ...
    static void dadesEntrenador(List<Persona> personas) {
